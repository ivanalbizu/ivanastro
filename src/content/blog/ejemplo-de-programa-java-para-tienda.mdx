...
slug: ejemplo-de-programa-java-para-tienda
published: true
...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/FqQSwOSC830?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
