...
slug: comparacion-de-imagenes-con-clip-path-y-javascript
published: true
...
image: ../../assets/images/comparacion-de-imagenes-con-clip-path-y-javascript.jpg
image_alt: Comparación de imágenes con clip-path y javascript
---
...
<Codepen id="wvajBXE" defaultTab="result" name={frontmatter.title} height="1200" />
...
<div class="container js-comparator">
  <div class="bg bg--2-left" style="background-image: ../../assets/images/url(img/ws06-gray_main.jpg);"></div>
  <div class="bg bg--2-right" style="background-image: ../../assets/images/url(img/ws06-purple_main.jpg);"></div>
</div>
```
