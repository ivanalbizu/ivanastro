...
categories:
  ...
  - html
  - css
date: "2020-03-08 15:10:00"
image: ../../assets/images/landing-css-grid.jpg
image_alt: Landing usando display grid y position sticky
---
...
<section class="container-grid container-grid--schema-1">
  ...
  <div class="div2 bg" style="background-image: ../../assets/images/url(img/underwater.jpg);"></div>
  <div class="div3 bg" style="background-image: ../../assets/images/url(img/marigold.jpg);"></div>
  ...
  <div class="div6 bg" style="background-image: ../../assets/images/url(img/kingfisher.jpg);"></div>
</section>
```
...
* Animación de scroll usando <code>scrollIntoView</code>
* Menú lateral con animación de SVG
* Uso de <code>mix-blend-mode</code> bajo el slider
