...
image: ../../assets/images/clip-path-banner-dat-gui.png
image_alt: Clip-path banner con dat.GUI para debug
---
...
import image from "../../assets/images/blog/clip-path-banner-dat-gui/banner-coords.jpg";

<Picture src={image} formats={['avif', 'webp']} alt="Coordenadas del banner" />
...
* <a href="/blog/comparacion-de-imagenes-con-clip-path-y-javascript/">Comparación de imágenes con clip-path</a>.
* <a href="/blog/transicion-de-atributos-filter-de-imagenes-y-clip-path/">Transición de imágenes modificando atributos filter</a>.
* <a href="/blog/clip-path-intersection-observer/">Animación de clip-path con Intersection Observer</a>.

## Pen con ejemplo Banner clip-path

import Codepen from '../../components/Codepen.astro'

<Codepen id="QWqyBgM" defaultTab="result" name={frontmatter.title} />
