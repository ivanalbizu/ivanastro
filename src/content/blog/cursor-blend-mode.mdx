---
title: "Cursor Blend Mode: Efectos creativos"
slug: cursor-blend-mode
description: "Tutorial sobre cómo crear un cursor personalizado con efectos de mezcla (blend-mode). Incluye análisis de rendimiento sobre la creación de estelas en el DOM."
published: true
categories:
  - javascript
  - css
date: "2022-08-31 22:10:00"
image: ../../assets/images/cursor-blend-mode.jpg
image_alt: "Cursor personalizado con efecto mix-blend-mode"
---

En este artículo exploramos cómo crear un cursor personalizado interactivo utilizando la propiedad CSS `mix-blend-mode`. Esta técnica permite fusionar colores e imágenes de elementos para crear efectos visuales llamativos.

* Para imágenes con <code>background-blend-mode</code>.
* Para resto de elementos <code>mix-blend-mode</code>.
