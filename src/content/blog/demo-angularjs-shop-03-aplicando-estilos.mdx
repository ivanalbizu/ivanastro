...
slug: demo-angularjs-shop-03-aplicando-estilos
published: true
...
.ribbon-green {
  ...
  background-image: ../../assets/images/-webkit-gradient(linear, left top, left bottom, from(#BFDC7A), to(#8EBF45)); 
  background-image: ../../assets/images/-webkit-linear-gradient(top, #BFDC7A, #8EBF45); 
  background-image: ../../assets/images/   -moz-linear-gradient(top, #BFDC7A, #8EBF45); 
  background-image: ../../assets/images/    -ms-linear-gradient(top, #BFDC7A, #8EBF45); 
  background-image: ../../assets/images/     -o-linear-gradient(top, #BFDC7A, #8EBF45); 
  color: #6a6340;
...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/rkaqYCFJ4dk?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
