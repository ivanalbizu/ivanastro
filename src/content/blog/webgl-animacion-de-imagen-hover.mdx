...
slug: webgl-animacion-de-imagen-hover
published: true
...
categories:
  - javascript
  - webgl
date: "2020-10-31 15:10:00"
image: ../../assets/images/webgl-hover-image.jpg
image_alt: Animación de Imágenes usando WebGL con librería curtainsJS y gsap
---
...
<Codepen id="ZEOeWam" defaultTab="result" name={frontmatter.title} />
...
* <code>&lt;section class="plane"&gt;</code>: donde colocaremos las tres imágenes con curtainsJS para crear las texturas, con su <code>data-sampler</code> para poder tratarlo dentro del <code>fragment shader</code>
...
* time: <code>uTime</code>
* mousepos: <code>uMouse</code>
* resolution: <code>uReso</code>
* progress: <code>uProgress</code>
