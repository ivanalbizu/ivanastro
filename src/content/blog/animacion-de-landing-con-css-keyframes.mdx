...
slug: animacion-de-landing-con-css-keyframes
published: true
...
categories:
  ...
  - html
  - css
date: "2020-12-27 15:10:00"
image: ../../assets/images/landing-keyframes-animations.PNG
image_alt: Animación de Landing con CSS keyframes
---
...
<Codepen id="bGwoKWg" defaultTab="result" name={frontmatter.title} />

* Para el primer componente he usado display grid para su versión desktop y flexbox para su versión Mobile.
* El segundo componente está todo usando display grid, con ajustes para Mobile y Desktop.
* El tercer componente está realizado por completo con flexbox. Conforme lo estaba haciendo, me fue más interesante resolverlo con flexbox por el tema de los colores de fondo a ancho completo y con saltos de colores en vertical.
...
* <code>purple__bg</code> color de fondo parcialmente debajo de la imagen.
* <code>purple__img</code> imagen del componente.
* <code>purple__txt</code> contenido del componente.
...
* <code>green__txt</code> contenido del componente.
* <code>green__bg</code> color de fondo debajo de las dos imágenes.
* <code>green__img-left / green__img-right</code> dos imágenes del componente.
...
* <code>blue__header</code> título del componente.
* <code>wrapper-blue--top</code> contenedor para textos, contador e imagen de calabaza.
* <code>wrapper-blue--bottom</code> contenedor para la lista y para la imagen de sipderman.
...
En el caso de contador de 0 a 9 se divide en 10 fracciones, y a cada paso se le resta una unidad. Cuando llega a 0 se restablecer el contador CSS ```100% { counter-reset: second-unit 0 }```
