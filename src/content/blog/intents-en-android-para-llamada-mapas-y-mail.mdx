...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/PuM4JO23VtM?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
