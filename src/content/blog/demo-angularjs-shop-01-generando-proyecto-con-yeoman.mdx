...
slug: demo-angularjs-shop-01-generando-proyecto-con-yeoman
...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/SRBe_1FBSMg?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
