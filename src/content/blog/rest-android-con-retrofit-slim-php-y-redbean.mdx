...
slug: rest-android-con-retrofit-slim-php-y-redbean
published: true
...
categories:
  ...
  - java
  - php
date: "2015-04-19 15:10:00"
---

import { Picture } from 'astro:assets';
import image from "../../assets/images/blog/rest-android-con-retrofit-slim-php-y-redbean/tree-rest-api.png";
...
*	Creamos una tabla llamada <code>users</code> que contendrá <code>id</code>, <code>name</code>, <code>mail</code> y <code>password</code>
*	Descargamos <a href="http://www.slimframework.com/" target="_blank">Slim PHP framework</a> y <a href="http://www.redbeanphp.com" target="_blank">RedBeanPHP</a>

La estructura de directorios y archivos quedará así:

<Picture src={image} formats={['avif', 'webp']} alt="Estructura proyecto Android con Retrofit" />
...
* <code>getAllUser(String uri)</code>. Obtener todos los usuarios.
* <code>delUser(String uri, String id)</code>. Borrar un usuario por su ID. (Usando <code>@Path</code> definido en <code>UsersAPI.java</code>)
* <code>newUser(String uri, User user)</code>. Crear nuevo usuario. (Usando <code>@Body</code>)
* Un cuarto método, <code>refreshListUser()</code>, para cargar el <code>ListView</code>.
...
* <code>getU(String uri, String id)</code>. Obtenemos el usuario por su ID. (Usando <code>@Path</code> de <code>UsersAPI.java</code>)
* <code>upUser(String uri, String id, User user)</code>. Obtenemos el usuario por su ID y los nuevos datos del usuario modificados. (Usando <code>@Path</code> y <code>@Body</code>)
