...
slug: animacion-de-slides-con-svg-y-css-con-display-grid
published: true
...
image: ../../assets/images/animacion-de-slides-con-svg-y-css-con-display-grid.png
image_alt: Animación de Slides con SVG y Css con display GRID
---
...
<Codepen id="QWypMNv" defaultTab="result" name={frontmatter.title} />
...
* Título de slide con <code>data-title data-split-word</code>.
* Párrafo con <code>data-translate-x</code>.
* Navegación entre Slides con <code>data-fade-in</code>.
* Animación de mágenes SVG con <code>data-image</code>.
* Animación de cada ítem de la lista con <code>data-translate-y</code>.
