...
En el menú superior, seleccionamos el ítem más a la derecha llamado <code>Project Index</code> y pinchamos al desplegar <code>Box URL</code>. Ahora se llamará <code>Box URL</code> en vez de <code>Project Index"</code>.
...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/z9yEURWZ5S0?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
