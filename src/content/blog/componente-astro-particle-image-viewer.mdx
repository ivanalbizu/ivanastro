...
- El dispositivo tiene **ambos**: poca memoria (< 4GB RAM) **y** pocos cores de CPU (≤ 2)
- WebGL no está soportado

**Compatibilidad con navegadores de privacidad**: El componente funciona correctamente en Brave y otros navegadores que falsifican información de hardware. La detección de dispositivos de gama baja requiere que ambos indicadores (memoria y cores) sean bajos, evitando falsos positivos cuando el navegador falsifica solo uno de ellos.
...
- **Astro**: 4.x y 5.x
- **Navegadores**: Todos los navegadores modernos con soporte WebGL, incluyendo navegadores de privacidad como Brave
