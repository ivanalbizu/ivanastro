...
categories:
  - css
  - javascript
date: "2021-12-08 19:10:00"
image: ../../assets/images/animating-css-vars.jpg
image_alt: animating css vars
---
...
* <code>initial-value:</code>: valor inicial.
* <code>inherits:</code>: si se puede heredar. Le pasamos <code>true</code>.
* <code>syntax</code>: le pasamos <code>'&lt;percentage&gt;'</code>.
...
<Codepen id="mdBEbEL" defaultTab="result" name={frontmatter.title} />
