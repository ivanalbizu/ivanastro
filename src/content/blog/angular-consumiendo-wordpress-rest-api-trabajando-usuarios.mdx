...
slug: angular-consumiendo-wordpress-rest-api-trabajando-usuarios
published: true
...
categories:
  ...
  - javascript
  - wordpress
date: "2016-05-08 15:10:00"
---

import { Picture } from 'astro:assets';
import image from "../../assets/images/blog/angular-consumiendo-wordpress-rest-api-trabajando-usuarios/jwt-header.png";
...
<Picture src={image} formats={['avif', 'webp']} alt="JWT - Json Web Token" />
