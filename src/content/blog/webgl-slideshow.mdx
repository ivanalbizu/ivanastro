...
image: ../../assets/images/slideshow-webgl-curtainsjs.jpg
image_alt: Animación de slideshow usando WebGL con librería curtainsJS
---
...
<Codepen id="OJXXbxd" defaultTab="result" name={frontmatter.title} />

## Recursos interesantes, al menos para un novato como yo en WebGL

* Si no tienes idea de que es WebGL, como yo, esta presentación fue las primeras que ví: <a href="https://www.youtube.com/watch?v=jkOnDTAFmD4" target="_blank" rel="noopener">https://www.youtube.com/watch?v=jkOnDTAFmD4</a>
* Tutorial paso a paso para trabajar con WebGL 2: <a href="https://webgl2fundamentals.org/" target="_blank" rel="noopener">https://webgl2fundamentals.org/</a>
* De un crack, Yuri Artyukh
  * Canal de youtube: <a href="https://www.youtube.com/user/flintyara" target="_blank" rel="noopener">https://www.youtube.com/user/flintyara</a>
  * Su Github: <a href="https://github.com/akella" target="_blank" rel="noopener">https://github.com/akella</a>
* Ejemplos muy PRO: <a href="https://webgl2fundamentals.org/" target="_blank" rel="noopener">http://acko.net/</a>
* Ejemplos en Codrops: <a href="https://tympanus.net/codrops/tag/webgl/" target="_blank" rel="noopener">https://tympanus.net/codrops/tag/webgl/</a>
...
*	<code>&lt;div class="canvas"&gt;</code>: envolvente donde se creará el elemento <code>canvas</code> con curtainsJS
*	<code>&lt;section class="slides multi-textures"&gt;</code>: donde colocaremos las imágenes del slideshow y que serán usadas con curtainsJS para crear las texturas
*	<code>&lt;button class="btn" data-goto="prev o next" type="button"&gt;</code>: botones para controlar la paginación de los slides
