...
import image1 from "../../assets/images/blog/crear-un-custom-post-en-wordpress/01.jpg";
import image2 from "../../assets/images/blog/crear-un-custom-post-en-wordpress/02.jpg";
import image3 from "../../assets/images/blog/crear-un-custom-post-en-wordpress/03.jpg";
import image4 from "../../assets/images/blog/crear-un-custom-post-en-wordpress/04.jpg";

<Picture src={image1} formats={['avif', 'webp']} alt="Schema Wordpress Rest Api 01" />

<Picture src={image2} formats={['avif', 'webp']} alt="Schema Wordpress Rest Api 02" />

<Picture src={image3} formats={['avif', 'webp']} alt="Schema Wordpress Rest Api 03" />

<Picture src={image4} formats={['avif', 'webp']} alt="Schema Wordpress Rest Api 04" />
