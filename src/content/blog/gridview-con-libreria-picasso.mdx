...
El primer archivo, `activity_main.xml`, contiene el GridView y su ID será `@+id/gridView`.
...
<iframe class="ratio-16-9" title={frontmatter.title} type="text/html" src="http://www.youtube.com/embed/LpLq3OC3478?autoplay=0&origin=https://ivanalbizu.eu/" frameborder="0"></iframe>
