---
title: "Storybook con Web Components Nativos: Guía de Integración"
slug: storybook-componente-web-nativo
description: "Tutorial paso a paso para integrar Web Components nativos (Vanilla JS) en Storybook. Aprende a crear stories, configurar controles y documentar tus componentes."
published: true
categories:
  - javascript
  - html
  - css
date: "2022-08-13 17:30:00"
image: ../../assets/images/storybook-con-componente-web-nativo.png
image_alt: "Interfaz de Storybook mostrando Web Components nativos"
---
...
## Configuración inicial: Creación del proyecto Storybook
...
## Estructura de archivos en Storybook para HTML
...
La instalación se genera con datos de ejemplo: ficheros de estilos CSS, componentes, recursos estáticos en <code>src/stories/assets</code> y fichero Readme. Estos ficheros son de ejemplo que se pueden eliminar. Es importante notar que los componentes de ejemplo generados para HTML **no son Web Components nativos** (no extienden de <code>HTMLElement</code> ni usan <code>customElements.define</code>), sino que utilizan <code>document.createElement()</code> o strings simples.
...
* <code>main.js</code>: contiene configuraciones. Por defecto indica las ruta de las stories y ficheros .mdx, así como los <code>addons</code> instalados
* <code>preview.js</code>: para la configuración de <code>actions</code> y <code>controls</code> del previsualizador de stories

Hasta aquí lo básico, no hay que tocar mucho. En mi caso eliminé los ejemplos, ajusté las rutas a las stories y añadí un nuevo <a href="https://github.com/ljcl/storybook-addon-cssprops" target="_blank" rel="noopener">addon de Custom Properties de CSS</a> para que se puedan personalizar las stories mediante variables CSS.

## Creación de Stories con Web Components Nativos
...
* <a href="/blog/webcomponent-canvas-particles/">Componente Web con Partículas en lienzo Canvas</a>
* <a href="/blog/tab-slots-web-component/">Tab Web component con Slots</a>
* <a href="/blog/webcomponent-tooltip-notification/">Webcomponent para tooltip notification</a>
