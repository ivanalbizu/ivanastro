...
## Recent Changes
- Separated marketing files into marketing repository
...
## Overview
This session focused on cleaning up the theme repository by separating marketing-related files into a dedicated private repository.
...
- Created comprehensive structure in /tmp/marketing/
...
- **Main Repo**: Public, theme-only files
- **Marketing Repo (marketing)**: Private, strategy and growth initiatives

### File Organization
\`\`\`
/                    # Clean theme repository
├── src/                       # Theme source
├── public/                    # Public assets
├── screenshots/               # Theme screenshots
└── claude-conversations/      # Private conversation logs (gitignored)

marketing/          # Separate marketing repository
