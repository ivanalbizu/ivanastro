...
async function generateScreenshots() {
  ...
  const baseURL = 'https://ivanalbizu.eu';
  ...
  await desktopPage.screenshot({ 
    path: join(__dirname, 'screenshots/homepage.png'),
    fullPage: false
  });
  ...
  await desktopPage.waitForLoadState('networkidle');
  await desktopPage.screenshot({ 
    path: join(__dirname, 'screenshots/blog.png'),
    fullPage: false
  });
  ...
  await desktopPage.waitForLoadState('networkidle');
  await desktopPage.screenshot({ 
    path: join(__dirname, 'screenshots/post.png'),
    fullPage: false
  });
  ...
  await desktopPage.waitForLoadState('networkidle');
  await desktopPage.screenshot({ 
    path: join(__dirname, 'screenshots/about.png'),
    fullPage: false
  });
  ...
  await desktopPage.waitForLoadState('networkidle');
  await desktopPage.screenshot({ 
    path: join(__dirname, 'screenshots/categories.png'),
    fullPage: false
  });
  ...
  await mobilePage.screenshot({ 
    path: join(__dirname, 'screenshots/mobile-home.png'),
    fullPage: false
  });
  ...
  await mobilePage.waitForLoadState('networkidle');
  await mobilePage.screenshot({ 
    path: join(__dirname, 'screenshots/mobile-post.png'),
    fullPage: false
  });
  ...
  await mobilePage.screenshot({ 
    path: join(__dirname, 'screenshots/mobile-menu.png'),
    fullPage: false
  });
  ...
  await featuredPage.screenshot({ 
    path: join(__dirname, 'screenshots/featured-main.png'),
    fullPage: false
  });
  ...
  console.log('\nGenerated files:');
  console.log('  - homepage.png (Desktop homepage)');
  console.log('  - blog.png (Blog listing)');
  console.log('  - post.png (Individual post)');
  console.log('  - about.png (About page)');
  console.log('  - categories.png (Categories page)');
  console.log('  - mobile-home.png (Mobile homepage)');
  console.log('  - mobile-post.png (Mobile blog post)');
  console.log('  - mobile-menu.png (Mobile navigation)');
  console.log('  - featured-main.png (Featured screenshot)\n');
}
